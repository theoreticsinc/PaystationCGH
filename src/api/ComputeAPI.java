...
public class ComputeAPI {
    ...
    private float OvernightPrice = 0;
...
//                //copy to last plate/card first
            ...
            if (pa.checkPTypeFromDB(ParkerType).equalsIgnoreCase("NOTFOUND") == true) {
                return 7;
            }
            ...
            PrksMsg[3] = pa.checkPTypeFromDB(ParkerType);
            ...
            PrksMsg[3] = pa.checkPTypeFromDB(ParkerType);   //in case trtype was overriden
...
//            }
    ...
    private String updateReceiptFiles(float AmountRCPT) {
        try {
            SaveCollData scd = new SaveCollData();
